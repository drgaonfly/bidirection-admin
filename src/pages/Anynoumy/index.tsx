...
// Status enum for anynoumy orders
const AnynoumyStatusEnum = {
  ...
  return (
    <PageContainer>
      <ProTable<API.ItemData, API.PageParams>
        headerTitle={intl.formatMessage({ id: 'anynoumy.list', defaultMessage: '匿名号码订单' })}
        actionRef={actionRef}
        rowKey="_id"
        ...
        request={(params, sort, filter) =>
          queryList('/anynoumies', { ...params, status: activeKey }, sort, filter)
        }
        columns={columns}
        rowSelection={{

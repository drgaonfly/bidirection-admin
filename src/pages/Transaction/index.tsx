  ...
  const columns: ProColumns<API.ItemData>[] = [
    ...
    },
    {
      ...
      valueEnum: {
        ...
        PledgeBalance: { text: intl.formatMessage({ id: 'stackignBalance' }) },
      },
      copyable: true,
      hideInSearch: true,
    },
    {
      ...
      valueType: 'select',
      valueEnum: {
        WithdrawalFailed: { text: intl.formatMessage({ id: 'withdrawalFailed' }) },
        Pledge: { text: intl.formatMessage({ id: 'stacking' }) },
        StaticIncome: { text: intl.formatMessage({ id: 'statciIncome' }) },
        LotteryReward: { text: intl.formatMessage({ id: 'LotteryReward' }) },
        TransferOut: { text: intl.formatMessage({ id: 'transferOut' }) },
        TransferIn: { text: intl.formatMessage({ id: 'transferIn' }) },
      },
      hideInSearch: true,
    },
    {

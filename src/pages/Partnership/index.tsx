...
const handleAdd = async (fields: API.ItemData) => {
  ...
  try {
    await addItem('/partnerships', { ...fields });
...
const handleUpdate = async (fields: FormValueType) => {
  ...
  try {
    await updateItem(`/partnerships/${fields._id}`, fields);
    hide();
...
const handleRemove = async (ids: string[]) => {
  ...
  try {
    ...
    const response = await removeItem('/partnerships', {
      ids,
    });
  ...
  return (
    <PageContainer>
      <ProTable<API.ItemData, API.PageParams>
        ...
        request={async (params, sort, filter) => queryList('/partnerships', params, sort, filter)}
        columns={columns}
        rowSelection={
          access.canSuperAdmin && {
